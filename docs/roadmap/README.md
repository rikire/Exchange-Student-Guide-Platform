...
| 1 | [01-requirements-design.md](01-requirements-design.md) | Requirements, CJM, C4, ERD, ADRs, routes, design reference | **Design doc, 11 Sep** | done, closed 26 Sep |
| 2 | [02-skeleton.md](02-skeleton.md) | Walking skeleton, schema, export/import, rest of the tooling | 20 Sep | done, closed 26 Sep |
...
Article content is written in parallel from phase 1 (4 Sep: moved from phase 0, since the seed
format is decided together with phase 1's glossary and ERD, not ahead of them). It does not depend
on the code, and an empty knowledge base at the mid-demo is the most likely way this project fails.
